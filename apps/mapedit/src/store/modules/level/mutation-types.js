...
export const SET_ACTOR_STARTING_POINT = 'SET_ACTOR_STARTING_POINT';
export const REMOVE_STARTING_POINT = 'REMOVE_ACTOR_STARTING_POINT';

export const SHIFT_GRID = 'SHIFT_GRID';
export const SHIFT_REGION = 'SHIFT_REGION';
