    ...
    >
        ...
        <div v-if="wallImages.length === 0">
            ...
            <ul>
                ...
                <li>Click on "{{ EMOJI.INBOX_TRAY }} import" to copy the selected tiles into the current project, and make them available as wall, floor or ceiling textures.</li>
            </ul>
        </div>
        <div v-else>
