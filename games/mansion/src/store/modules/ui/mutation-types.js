...
// show first popup in list
export const SHOW_POPUP = 'SHOW_POPUP';

// show/hide HUD (life bar, indicators etc...)
export const SET_HUD_VISIBLE = 'SET_HUD_VISIBLE';

// define score score details
export const SET_SHOT = 'SET_SHOT';

// clear and hide shot details
export const CLEAR_SHOT = 'CLEAR_SHOT';

// show/hide album
export const SET_UI_FRAME_VISIBLE = 'SET_UI_FRAME_VISIBLE';
...
// clue : a photo that gives an hint on how to progress throught the game
...
export const SET_TODO_INNER_PHASE = 'SET_TODO_INNER_PHASE';
export const SET_NOTE_SELECTED_TYPE = 'SET_NOTE_SELECTED_TYPE';
export const SET_GAME_OVER_PROMPT_VISIBLE = 'SET_GAME_OVER_PROMPT_VISIBLE';
export const SET_END_OF_GAME_VISIBLE = 'SET_END_OF_GAME_VISIBLE';

export const SET_MOUSE_FACTOR = 'SET_MOUSE_FACTOR'
export const SET_MUSIC_VOLUME = 'SET_MUSIC_VOLUME'
export const SET_SFX_VOLUME = 'SET_SFX_VOLUME'

export const ADD_NOTE_ENTRY = 'ADD_NOTE_ENTRY'