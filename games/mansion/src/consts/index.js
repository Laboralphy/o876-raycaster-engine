...
export const PHOTO_SCORE_EPIC = 500; // photo épique
...
export const AUDIO_EVENT_GHOST_SPAWN = 204;
...
export const AUDIO_EVENT_AMBIANCE_LOOP = 400
export const AUDIO_EVENT_AMBIANCE_TRIGGER = 401
