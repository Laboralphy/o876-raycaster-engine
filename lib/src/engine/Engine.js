...
// |_|
    ...
    pushBlock(entity, x, y) {
        ...
        const bDoor = nPhys >= RC_CONSTS.PHYS_FIRST_DOOR && nPhys <= RC_CONSTS.PHYS_LAST_DOOR;
...
//                       |___/                               |___/
    ...
    createEntity(resref, location) {
        ...
        if (!(resref in this._blueprints)) {
            throw new Error('this blueprint does not exist : "' + resref + '". Did you mean "' + suggest(resref, Object.keys(this._blueprints)) + '"');
        }
