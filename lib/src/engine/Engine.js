...
class Engine {
    constructor() {
        ...
        this._config = {
            urls: {
                FETCH_LEVEL: CONSTS.FETCH_LEVEL_URL,
                FETCH_DATA: CONSTS.FETCH_DATA_URL,
            },
...
// |__/                  |_|
     ...
     * @return {Promise<void>}
     */
    async buildLevel(data, monitor, extra) {
        // validation json
...
// |__/
     ...
     */
    fetchLevel(sName) {
        return fetchJSON(this._config.urls.FETCH_LEVEL.replace(/:name/, sName));
    }
     ...
     */
    fetchData(sName) {
        return fetchJSON(this._config.urls.FETCH_DATA.replace(/:name/, sName));
    }
