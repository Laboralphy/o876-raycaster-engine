...
export const FETCH_LEVEL_URL = '/game/assets/levels/:name.json';
export const FETCH_DATA_URL = '/game/assets/data/:name.json';
export const FETCH_LEVEL_LIST_URL = '/game/levels';
