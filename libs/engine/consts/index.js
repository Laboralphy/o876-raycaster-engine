...
export const DOOR_PHASE_CLOSED = 0;          // initial state : door is closed and not openned yet
...
export const METRIC_CAMERA_DEFAULT_SIZE = 24; // default size for visor entity
